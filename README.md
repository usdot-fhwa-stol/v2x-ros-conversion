...
[v2x-ros-driver](https://github.com/usdot-fhwa-stol/v2x-ros-driver) is the driver for use with a variety of V2X radios. It provides the bidirectional communication between ROS and a connected V2X radio (both OBUs and RSUs) using carma_driver_msgs/msg/ByteArray ROS messages carrying UPER-encoded V2X data.
